# Statement for Machine Learning: Permission Required

version 1.0

私のコンテンツの利用に関して:
- その用途、目的、手段(学習、推論のいずれも含みます)のいかんにかかわらず、無断での機械学習への利用を禁止します。
- 機械学習への利用を行いたい場合は、許諾が必要です。事前に私に連絡をしてください。誠意と責任をもって応対します。
...
あなたの紹介文に、State4ML-Rの下でコンテンツを公開している旨とこの文書の参照を追加してください。
